<template>
	<div class="login-container">
		...
		<el-dialog title="注册" :visible.sync="dialogFormVisible">
			...
			<el-input v-model="user.uname" placeholder="请输入用户名" style="margin-bottom: 20px; "></el-input>
			<el-input v-model="user.pwd" placeholder="请输入密码" style="margin-bottom: 20px;" show-password>></el-input>
			<!-- <el-input v-model="user.email" placeholder="请输入邮箱" style="margin-bottom: 20px;"></el-input>
...
<script>
	...
	import myAxios from "@/api/company_style";
	...
	export default {
		...
		methods: {
			...
			webRegister() {
				//uname, String pwd,String age,String sex,String major,String grade,String email,String phone
				myAxios.webRegister1(this.user.uname,
						this.user.pwd,
						this.user.age,
						this.user.sex,
						this.user.major,
